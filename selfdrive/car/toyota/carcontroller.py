...
class CarController:
  ...
  def update(self, CC, CS, dragonconf):
    ...
    if not dragonconf.dpToyotaSng and CS.out.standstill and not self.last_standstill and self.CP.carFingerprint not in NO_STOP_TIMER_CAR:
    ...
    if not dragonconf.dpToyotaLdw:
      hud_control.leftLaneDepart = False
      hud_control.rightLaneDepart = False
